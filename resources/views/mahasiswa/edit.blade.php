...
<div class="container">
        ...
        <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control"  style="width:900px;" value="{{$mahasiswa->nama}}" name="nama"  placeholder="Mahasiswa">
                </div>
        </div>  
         ...
         <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" style="width:900px;" value="{{$mahasiswa->nim}}" name="nim" placeholder="Nim">
                </div>
            </div>   
      ...
      <!-- input form buat tgl mahasiswa -->
         <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="date" class="form-control" style="width:900px;" value="{{$mahasiswa->tanggal_lahir}}" name="tanggal_lahir" placeholder="Alamat">
                </div>
         </div> 
     ...
     <!-- input form buat alamat mahasiswa -->
         <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" style="width:900px;" value="{{$mahasiswa->alamat}}" name="alamat" placeholder="Alamat">
                </div>
          </div>  
      ...
      <!-- input form buat tahun masuk mahasiswa -->
         <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" style="width:900px;" value="{{$mahasiswa->tahun_masuk}}" name="tahun_masuk" placeholder="Tahun masuk">
                </div>
          </div>  
     ...
     <!-- input form Create at mahasiswa -->
         <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="date" class="form-control" style="width:900px;" value="{{$mahasiswa->create_at}}" name="create_at" placeholder="create at">
                </div>
         </div>  
       ...
       <!-- input form Update at mahasiswa -->
         <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                <input type="date" class="form-control" style="width:900px;" value="{{$mahasiswa->update_at}}" name="update_at" placeholder="update at">
                </div>
        </div>  
